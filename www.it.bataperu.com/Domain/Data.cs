...
namespace www.it.bataperu.com.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 1, nameOption = "Config Tienda", controller = "Configuracion", action = "Index", imageClass = "fa fa-fw fa-edit", estatus = true });
            ...
            menu.Add(new Navbar { Id = 2, nameOption = "Consulta Vales", controller = "Cupones", action = "Index", imageClass = "fa fa-fw fa-wrench", estatus = true });
        ...
        public IEnumerable<User> users()
        {
            ...
            users.Add(new User { Id = 1, user = "david", password = "123", estatus = true, RememberMe = true });
            users.Add(new User { Id = 2, user = "Soporte", password = "Bata2017", estatus = true, RememberMe = false });
